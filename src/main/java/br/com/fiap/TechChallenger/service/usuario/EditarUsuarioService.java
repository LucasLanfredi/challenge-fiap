    ...
    public class EditarUsuarioService {
        ...
        public ResponseEntity<UsuarioResponse> editarUsuarioByUserId(UsuarioEditDTO editarUsuarioRequest, Long userId) {
            ...
            return ResponseEntity.status(HttpStatus.OK)
                    .body(UsuarioResponse.fromEntity(usuarioAtualizado));
        }
